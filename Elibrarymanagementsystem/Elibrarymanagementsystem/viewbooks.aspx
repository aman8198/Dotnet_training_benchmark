<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewbooks.aspx.cs" Inherits="Elibrarymanagementsystem.viewbooks" %>
                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Elib_DBConnectionString %>" SelectCommand="SELECT * FROM [book_master_tbl]"></asp:SqlDataSource>
                                    <div class="col">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            ...
                                                                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Text='<%# Eval("genere") %>'></asp:Label>
                                                                            &nbsp;|
                                                                            <span>
                                                      Language -<span>&nbsp;</span>
